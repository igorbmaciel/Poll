...
{
    public class AddTaskCommandTest : TnfIntegratedTestBase
    {
        ...
        public void Should_Not_Have_Validation_Error_When_Valid_Command()
        {
            ...
            //assert
            Assert.DoesNotContain(command.ValidationResult.Errors, e => e.CustomState is EntityError.InvalidTaskName);            
        }
